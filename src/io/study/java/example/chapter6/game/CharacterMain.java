...
public class CharacterMain {
    public static void main(String args[]){
        ...
        System.out.println("- 공격력  "+characterWeapon.getWpUpgrade()+("기본"+character.getCharacterAtkPoint()+"무기"+characterWeapon.getWpUpgrade()));
        System.out.println("- 방력 : "+characterDefence.getDfUpgrade()+("기본"+character.getCharacterDfPoint()+"무기"+characterDefence.getDfUpgrade()));
